...
public class PermissionController {
    ...
    public GenericResponse<List<PermissionDto>> getAllPermissions() {
        ...
        return GenericResponse.success(permissions, "Permissions retrieved successfully");
    }
    //  Get Permission By ID
    @GetMapping("/{id}")
    public GenericResponse<PermissionDto> getPermissionById(@PathVariable Long id) {
        PermissionDto dto = permissionService.getPermissionById(id);
        return GenericResponse.success(dto, "Permission retrieved successfully");
    }
}
